...
var relatedProductRoutes = require('./routes/relatedProducts');
var curentProductInformationRoute = require('./routes/currentProductInformation');
const ratingsAndReviewsRoutes = require('./routes/ratingsAndReviewsRoutes.js');
...
app.put('/answer/update', (req, res) => {
  ...
  axios.put(markAns, {}, headers)
    ...
    .catch(reject => console.log('failed in server', reject));
});
...
app.put('/questions/update', (req, res) => {
  ...
  axios.put(markHelpful, {}, headers)
    .then(response => res.status(204).send(response.data))
    .catch(reject => console.log('qa_markQHelpful failed in sever', reject));
});
...
app.post('/qa/question/answer', (req, res) => {
  ...
  axios.post(addAnswer, {
    ...
    .catch(reject => console.log('failed in server posting', reject));
});
...
app.post('/qa/question/post', (req, res) => {
  ...
  axios.post(addQuestion, {
    ...
    .then(response => res.status(201).send(response.data))
    .catch(reject => console.log('failed in server posting Q', reject));
})
